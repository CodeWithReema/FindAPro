"""
Django settings for FindAPro project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='findapro'),
        'USER': config('POSTGRES_USER', default='findapro_user'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='findapro_password'),
